...
stops: int = 0
ask: str = "What do you want to do, where do you want to go?"
...
areas = {
    "home": {"name": "Home", "summary": "You wake up to the coldness of your house. \nYou decide to put on some warm clothes and boots before going outside to get something to eat and drink at the pub.", "details": "Your home smells like a cross between a Stop & Shop and Minnesota.", "was_visited": False},
    "village": {"name": "The Village", "summary": "You exit to the snappy and frigid morning air. \nSnow covers everything around you and the sun is blocked out by gray clouds. You decide to shovel your driveway later.", "details": "The pub is up the road a fair bit from your home so you get to walking. \nYou can also go south to the lake.\nFor some odd reason, the snow on the sidewalk seems to be cleared out from people walking through it.", "was_visited": False},
    "pub": {"name": "The Pub", "summary": "You enter the pub to see that its mostly empty. Some of your neighbors are enjoying breakfast and coffee. \nYou find a seat and order a full English. You also order yourself a coffee. \nYou finish your food and go back outside.", "details": "The food was sorta cold, but the coffee filled your stomach with warmth. There was a girl with an umbrella making small talk to the man at the bar.", "was_visited": False},
    "frozen_lake": {"name": "The Frozen Lake", "summary": "You walk out of the village towards the now frozen lake nearby. \nA small bit of the lake still visible as the mouth of a river is flowing into it.", "details": "A meadow borders the lake in the direction your walking. You can also hear a train blow its whistle in the distance.", "was_visited": False},
    "meadow": {"name": "The Meadow", "summary": "A lone tree stands in the middle of the meadow. You see some birds flying to and from the tree as you're walking by.", "details": "You see the river ahead of you as you are walking. The birds are very loud to each other, and it seems like there are more hidden in the tree.", "was_visited": False},
    "river": {"name": "The River", "summary": "The river still flows despite the frigid temperature. Its a very bright blue.", "details": "You take your hand out of its glove and test the water. \nYou find that its cold.\nYou keep walking along the river. You also see an old campsite on the western side of the river.", "was_visited": False},
    "campsite": {"name": "The Campsite", "summary": "You decide to head towards it and forge the river by walking over some rocks.", "details": "The campsite is fairly new, but the coals in the firepit are icy to the touch. \nSome snowed on leftover tents make up the rest of the campsite.\nYou see a swamp bordering the northern side of the campsite and an array of cliffs past it.", "was_visited": False},
    "swamp": {"name": "The Swamp", "summary": "You eventually find yourself in an ice-covered swamp. Trees sprout from small land masses throughout the swamp.", "details": "You stop and notice a deer on the far side of the swamp. \nBefore you can move again, it notices you and runs away.\nYou carefully walk over the ice of the swamp.", "was_visited": False},
    "cliffs": {"name": "The Cliffs", "summary": "You find yourself at the base of the cliffs. You look above you and see more cliffs jutting out on top of each other.", "details": "\nA small pathway can be seen clearly carved along the cliffside going north towards the top", "was_visited": False},
    "rock": {"name": "The Rock", "summary": "You make your way to the top of the cliffside and find yourself graced by the presence of a large rock.", "details": "You take a look around you and decide to take a picture of your surroundings. \nhttps://cdn.discordapp.com/attachments/311944103804010496/1020799631766069331/unknown.png", "was_visited": False},
    }
